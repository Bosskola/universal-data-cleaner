...
A Python toolkit that automatically cleans messy CSV and Excel files.
...
| Symbol | Meaning |
|--------|---------|
| ` ```python ` | START code block (blue background) |
| ` ``` ` | END code block (back to normal) |
| `**bold**` | Bold text |
| `- ` | Bullet point |
| `` `word` `` | Inline code (gray background) |
...
- **Consolidates scattered contact info** into clean, single columns
- **Exports** to CSV, Excel, and JSON formats
- **Documents** everything with full audit trail
